var card = function (r) {
    ...
    function d(r) {
        for (var e = -1, t = 0; t < i.length; t++) if (i[t].identifier === r) {
            e = t;
            break
        }
        return e
    ...
    function c(r, e) {
        for (var t = {}, a = [], n = 0; n < r.length; n++) {
            var o = r[n], c = e.base ? o[0] + e.base : o[0], p = t[c] || 0, l = "".concat(c, " ").concat(p);
            t[c] = p + 1;
            var s = d(l), f = {css: o[1], media: o[2], sourceMap: o[3]};
    ...
    function p(r) {
        var e = document.createElement("style"), a = r.attributes || {};
        if (void 0 === a.nonce) {
            var n = t.nc;
            n && (a.nonce = n)
        }
        ...
        })), "function" == typeof r.insert) r.insert(e); else {
    ...
    function f(r, e, t, a) {
        ...
        if (r.styleSheet) r.styleSheet.cssText = s(e, n); else {
            var o = document.createTextNode(n), i = r.childNodes;
            i[e] && r.removeChild(i[e]), i.length ? r.insertBefore(o, i[e]) : r.appendChild(o)
        }
    }

    function u(r, e, t) {
        var a = t.css, n = t.media, o = t.sourceMap;
        if (n ? r.setAttribute("media", n) : r.removeAttribute("media"), o && "undefined" != typeof btoa && (a += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(o)))), " */")), r.styleSheet) r.styleSheet.cssText = a; else {
    ...
    function j(r, e) {
        ...
        if (e.singleton) {
            var o = b++;
            t = g || (g = p(e)), a = f.bind(null, t, o, !1), n = f.bind(null, t, o, !0)
        } else t = p(e), a = u.bind(null, t, e), n = function () {
            !function (r) {
    ...
    var a, n, o = [].slice;
    n = t(4), (a = t(15)).card = {}, a.card.fn = {}, a.fn.card = function (r) {
    ...
    (function (e) {
        var a, n, o;
        t(6), n = t(7), t(8), o = t(9), a = function () {
            var r, e;
            ...
            return t.prototype.initializedDataAttr = "data-jp-card-initialized", t.prototype.cardTemplate = '<div class="jp-card-container"><div class="jp-card"><div class="jp-card-front"><div class="jp-card-logo jp-card-elo"><div class="e">e</div><div class="l">l</div><div class="o">o</div></div><div class="jp-card-logo jp-card-visa">Visa</div><div class="jp-card-logo jp-card-visaelectron">Visa<div class="elec">Electron</div></div><div class="jp-card-logo jp-card-mastercard">Mastercard</div><div class="jp-card-logo jp-card-maestro">Maestro</div><div class="jp-card-logo jp-card-amex"></div><div class="jp-card-logo jp-card-discover">discover</div><div class="jp-card-logo jp-card-unionpay">UnionPay</div><div class="jp-card-logo jp-card-dinersclub"></div><div class="jp-card-logo jp-card-hipercard">Hipercard</div><div class="jp-card-logo jp-card-troy">troy</div><div class="jp-card-logo jp-card-dankort"><div class="dk"><div class="d"></div><div class="k"></div></div></div><div class="jp-card-logo jp-card-jcb"><div class="j">J</div><div class="c">C</div><div class="b">B</div></div><div class="jp-card-lower"><div class="jp-card-shiny"></div><div class="jp-card-cvc jp-card-display">{{cvc}}</div><div class="jp-card-number jp-card-display">{{number}}</div><div class="jp-card-name jp-card-display">{{name}}</div><div class="jp-card-expiry jp-card-display" data-before="{{monthYear}}" data-after="{{validDate}}">{{expiry}}</div></div></div><div class="jp-card-back"><div class="jp-card-bar"></div><div class="jp-card-cvc jp-card-display">{{cvc}}</div><div class="jp-card-shiny"></div></div></div></div>', t.prototype.template = function (r, e) {
                ...
                var o, i, d, c, p, l, s, f, u, g, b, j;
                for (j = function () {
                    var e, t, a;
                    for (a = [], e = 0, t = r.length; e < t; e++) o = r[e], a.push(n.val(o));
                    return a
                }(), c = a.join(j), (j = j.join(c)) === c && (j = ""), d = 0, l = (g = a.filters).length; d < l; d++) j = (0, g[d])(j, r, e);
                for (b = [], i = p = 0, s = e.length; p < s; i = ++p) f = e[i], u = a.fill ? j + t[i].substring(j.length) : j || t[i], b.push(f.textContent = u);
                return b
    ...
    "use strict";
    t.r(e);
    var a = t(1), n = t.n(a), o = t(0), i = {insert: "head", singleton: !1};
    n()(o.a, i);
    ...
    !function (r) {
        ...
        var a, n, o, i, d, c, p, l, s, f, u, g, b, j, h, m, v, x, y, w, k, C, E, z, $, N,
        ...
        h = t(1)(), n = t(4), d = [{
            ...
            cvcLength: [3],
            luhn: !0
        }, {type: "troy", pattern: /^9792/, format: p, length: [16], cvcLength: [3], luhn: !0}, {
            type: "unionpay",
            pattern: /^62/,
            format: p,
            length: [16, 17, 18, 19],
            ...
            cvcLength: [3],
            luhn: !0
        }, {type: "visa", pattern: /^4/, format: p, length: [13, 16, 19], cvcLength: [3], luhn: !0}], o = function (r) {
            var e, t, a, n, o;
            ...
            return setTimeout((function () {
                var e, t;
                return e = r.target, t = n.val(e), t = a.fns.formatCardNumber(t), c(e, t), n.trigger(e, "change")
            }))
        }, f = function (r) {
            return function (e) {
                var t, a, i, d, c, p, l, s, f, u, g;
                if (e.which > 0 ? (a = String.fromCharCode(e.which), g = n.val(e.target) + a) : (a = e.data, g = n.val(e.target)), /^\d+$/.test(a)) {
                    for (s = e.target, t = o(g), p = g.replace(/\D/g, "").length, u = [16], t && (u = t.length), r && (u = u.filter((function (e) {
                        return e <= r
                    }))), i = d = 0, c = u.length; d < c; i = ++d) if (!(p >= (f = u[i]) && u[i + 1]) && p >= f) return;
                    if (!m(s)) return l = t && "amex" === t.type ? /^(\d{4}|\d{4}\s\d{6})$/ : /(?:^|\s)(\d{4})$/, g = g.substring(0, g.length - 1), l.test(g) ? (e.preventDefault(), n.val(s, g + " " + a), n.trigger(s, "change")) : void 0
                }
            }
        }, l = function (r) {
            var e, t;
            if (e = r.target, t = n.val(e), !r.meta && 8 === r.which && !m(e)) return /\d\s$/.test(t) ? (r.preventDefault(), n.val(e, t.replace(/\d\s$/, "")), n.trigger(e, "change")) : /\s\d?$/.test(t) ? (r.preventDefault(), n.val(e, t.replace(/\s\d?$/, "")), n.trigger(e, "change")) : void 0
        }, u = function (r) {
            var e, t, a;
            if (t = r.target, r.which > 0 ? (e = String.fromCharCode(r.which), a = n.val(t) + e) : (e = r.data, a = n.val(t)), /^\d+$/.test(e)) return /^\d$/.test(a) && "0" !== a && "1" !== a ? (r.preventDefault(), n.val(t, "0" + a + " / "), n.trigger(t, "change")) : /^\d\d$/.test(a) ? (r.preventDefault(), n.val(t, a + " / "), n.trigger(t, "change")) : void 0
        }, j = function (r) {
            var e, t, a;
            ...
            var e, t;
            if (!r.metaKey && (e = r.target, t = n.val(e), 8 === r.which && !m(e))) return /\d(\s|\/)+$/.test(t) ? (r.preventDefault(), n.val(e, t.replace(/\d(\s|\/)*$/, "")), n.trigger(e, "change")) : /\s\/\s?\d?$/.test(t) ? (r.preventDefault(), n.val(e, t.replace(/\s\/\s?\d?$/, "")), n.trigger(e, "change")) : void 0
        }, z = function (r) {
            var e;
            ...
            return function (e) {
                var t, a, i, d, c;
                if (d = e.target, a = String.fromCharCode(e.which), /^\d+$/.test(a) && !m(d)) return c = (n.val(d) + a).replace(/\D/g, ""), i = 16, (t = o(c)) && (i = t.length[t.length.length - 1]), r && (i = Math.min(i, r)), c.length <= i ? void 0 : e.preventDefault()
            }
        }, C = function (r, e) {
            var t, a;
            if (a = r.target, t = String.fromCharCode(r.which), /^\d+$/.test(t) && !m(a)) return (n.val(a) + t).replace(/\D/g, "").length > e ? r.preventDefault() : void 0
        }, k = function (r) {
            return C(r, 6)
        }, E = function (r) {
            return C(r, 2)
            ...
            var e, t;
            if (t = r.target, e = String.fromCharCode(r.which), /^\d+$/.test(e) && !m(t)) return (n.val(t) + e).length <= 4 ? void 0 : r.preventDefault()
        }, N = function (r) {
            var e, t, o, i, c;
            ...
            var t;
            if (t = r.selectionEnd, n.val(r, e), t) return r.selectionEnd = t
        }, a = function () {
            function r() {
            }
            ...
            return r.J = n, r.fns = {
                cardExpiryVal: function (r) {
                    ...
                    var e, t;
                    return r = (r + "").replace(/\s+|-/g, ""), !!/^\d+$/.test(r) && (!!(e = o(r)) && (t = r.length, D.call(e.length, t) >= 0 && (!1 === e.luhn || v(r))))
                    ...
                    var t, a;
                    return r = n.trim(r), !!/^\d+$/.test(r) && (e && i(e) ? (t = r.length, D.call(null != (a = i(e)) ? a.cvcLength : void 0, t) >= 0) : r.length >= 3 && r.length <= 4)
                }, cardType: function (r) {
                    var e;
                ...
                return n.on(r, "keypress", z), n.on(r, "input", z)
            }, r.cardExpiryVal = function (e) {
                return r.fns.cardExpiryVal(n.val(e))
            }, r.formatCardCVC = function (e) {
                return r.restrictNumeric(e), n.on(e, "keypress", y), n.on(e, "input", y), e
            }, r.formatCardExpiry = function (e) {
                var t, a;
                return r.restrictNumeric(e), e.length && 2 === e.length ? (t = e[0], a = e[1], this.formatCardExpiryMultiple(t, a)) : (n.on(e, "keypress", k), n.on(e, "keypress", u), n.on(e, "keypress", b), n.on(e, "keypress", g), n.on(e, "keydown", s), n.on(e, "input", u)), e
            }, r.formatCardExpiryMultiple = function (r, e) {
                return n.on(r, "keypress", E), n.on(r, "keypress", j), n.on(r, "input", j), n.on(e, "keypress", $), n.on(e, "input", $)
            }, r.formatCardNumber = function (e, t) {
                return r.restrictNumeric(e), n.on(e, "keypress", w(t)), n.on(e, "keypress", f(t)), n.on(e, "keydown", l), n.on(e, "keyup blur", N), n.on(e, "paste", x), n.on(e, "input", f(t)), e
 ...
 */
    var a = t(11), n = t(12), o = Object.defineProperty, i = Object.getOwnPropertyDescriptor, d = function (r, e, t) {
    ...
    r.exports = function r() {
        var e, t, n, o, i, p, l = arguments[0] || {}, s = 1, f = arguments.length, u = !1;
        for ("boolean" == typeof l && (u = l, l = arguments[1] || {}, s = 2), "object" == typeof l || a.fn(l) || (l = {}); s < f; s++) if (null != (e = arguments[s])) for (t in "string" == typeof e && (e = e.split("")), e) n = c(l, t), l !== (o = c(e, t)) && (u && o && (a.hash(o) || (i = a.array(o))) ? (i ? (i = !1, p = n && a.array(n) ? n : []) : p = n && a.hash(n) ? n : {}, d(l, t, r(u, p, o))) : void 0 !== o && d(l, t, o));
        return l
    }
}, function (r, e, t) {
    "use strict";
     ...
     * @license MIT
     */var a, n, o = Object.prototype, i = o.hasOwnProperty, d = o.toString;
    ...
    var c = function (r) {
        ...
        l = /^([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{4}|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)$/, s = /^[A-Fa-f0-9]+$/,
        f = {};
    f.a = f.type = function (r, e) {
        ...
        var e = "[object Arguments]" === d.call(r), t = !f.array(r) && f.arraylike(r) && f.object(r) && f.fn(r.callee);
        return e || t
        ...
        var t = f.infinite(r), a = f.infinite(e), n = f.number(r) && !c(r) && f.number(e) && !c(e) && 0 !== e;
        return t || a || n && r % e == 0
    ...
    "use strict";
    var a = "Function.prototype.bind called on incompatible ", n = Array.prototype.slice, o = Object.prototype.toString;
    r.exports = function (r) {
        var e = this;
