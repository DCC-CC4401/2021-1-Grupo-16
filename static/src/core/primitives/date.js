 ...
 */
Date.getSecondsBetween = function ($finish, $init) {
...
/**
 * Returns the seconds after an initial date.
 *
 * @this {Date}
 * @param {Date} $time - Init date
 * @returns {number} - Number of seconds
 */
Date.getSecondsFrom = function ($time) {

    return Date.getSecondsBetween(new Date(), $time);
...
/**
 * Returns locale date format.
 *
 * @this {Date}
 * @returns {string}
 */
Date.getLocaleFormat = function () {
